...
public class PerformanceTestRunner {
    ...
    private static void testConfigurationOptimizationImpact() {
        ...
        UltraPerformanceConfiguration config = UltraPerformanceConfiguration.load();
        ...
        // Verify aggressive preallocation and swap batch size increase (64 vs 32)
        int swapBatchSize = config.getSwapBatchSize();
        System.out.printf("   Swap Batch Size: %d (should be 64)%n", swapBatchSize);
        assertEquals(64, swapBatchSize, "Swap batch size should be increased to 64");
