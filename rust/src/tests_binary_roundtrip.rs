...
mod tests {
    ...
    fn block_roundtrip_deserialize_process_serialize() {
        ...
        let input = crate::flatbuffers::conversions::deserialize_block_input(&out).expect("deserialize_block_input failed");
        ...
        let bytes = crate::flatbuffers::conversions::serialize_block_result(&result).expect("serialize_block_result failed");
    ...
    fn entity_roundtrip_deserialize_process_serialize() {
        ...
        let input = crate::flatbuffers::conversions::deserialize_entity_input(&out).expect("deserialize_entity_input failed");
        ...
        let bytes = crate::flatbuffers::conversions::serialize_entity_result(&result).expect("serialize_entity_result failed");
