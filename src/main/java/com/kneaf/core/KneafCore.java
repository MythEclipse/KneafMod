...
public class KneafCore {
    ...
    public KneafCore(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Initialize async logging system FIRST untuk ensure all logging is
        // non-blocking
    ...
    private static float[] matrixMultiply(float[] a, float[] b) {
        ...
        if (a.length != 16 || b.length != 16)
            throw new IllegalArgumentException("Only 4x4 matrices are supported");
    ...
    public static Vector3f quaternionRotateVector(Quaternionf q, Vector3f v) {
        if (q == null || v == null)
            throw new IllegalArgumentException("Quaternion and vector cannot be null");
    ...
    /**
     * Computes the dot product of two 3D vectors represented as float arrays of
     * length 3.
     *
    ...
    private static float vectorDot(float[] a, float[] b) {
        ...
        if (a.length != 3 || b.length != 3)
            throw new IllegalArgumentException("Only 3D vectors are supported");
        return a[0] * b[0] + a[1] * b[1] + a[2] * b[2];
    }

    /**
     * Computes the cross product of two 3D vectors represented as float arrays of
     * length 3.
     *
     * @param a the first vector
     * @param b the second vector
