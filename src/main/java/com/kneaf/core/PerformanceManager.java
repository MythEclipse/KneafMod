...
public final class PerformanceManager {
    ...
    public void loadConfiguration() {
        ...
        try {
            ...
            isCombatParallelProcessingEnabled
                    .set(parseBooleanProperty(properties, "combatParallelProcessingEnabled", true));
            isPredictiveLoadBalancingEnabled
                    .set(parseBooleanProperty(properties, "predictiveLoadBalancingEnabled", true));
