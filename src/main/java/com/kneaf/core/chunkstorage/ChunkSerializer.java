...
/**
 * Abstract serializer interface for converting chunks to/from binary format. Supports NBT
 * serialization format for flexibility. This interface uses Object types to avoid Minecraft class
...
public interface ChunkSerializer {
  ...
  /**
   * Get the format identifier for this serializer. Used for versioning and format detection.
   *
  ...
  /**
   * Get the version of this serializer format. Used for compatibility checking and data migration.
   *
