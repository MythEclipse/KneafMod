...
/**
 * Compatibility shim for tests expecting com.kneaf.core.chunkstorage.RustDatabaseAdapter. Delegates
 * behavior to com.kneaf.core.chunkstorage.database.RustDatabaseAdapter.
 */
public class RustDatabaseAdapter extends com.kneaf.core.chunkstorage.database.RustDatabaseAdapter {
  ...
  public com.kneaf.core.chunkstorage.DatabaseAdapter.DatabaseStats getStats() {
    ...
    if (raw instanceof java.util.Map) {
      ...
      return new DatabaseAdapter.DatabaseStats(
          totalChunks,
          totalSize,
          readLatency,
          writeLatency,
