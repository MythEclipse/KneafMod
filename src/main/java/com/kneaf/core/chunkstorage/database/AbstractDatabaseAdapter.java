...
public abstract class AbstractDatabaseAdapter implements DatabaseAdapter {
    ...
    public boolean swapOutChunk(String chunkKey) throws IOException {
        ...
        try {
            ...
            ChunkStorageExceptionHandler.logDebug(getDatabaseType(), "Swap out failed for chunk {}: {}", chunkKey, e.getMessage());
            return false;
        }
    }
    ...
    public Optional<byte[]> swapInChunk(String chunkKey) throws IOException {
        ...
        try {
            ...
            ChunkStorageExceptionHandler.logDebug(getDatabaseType(), "Swap in failed for chunk {}: {}", chunkKey, e.getMessage());
            return Optional.empty();
        }
    }
    ...
    public String toString() {
        return String.format("%s[name=%s, healthy=%s]", getClass().getSimpleName(), databaseName, healthy);
    }
}