...
public final class PerformanceOverlayClient {
    ...
    public static void registerClient(FMLClientSetupEvent event) {
        ...
        try {
            ...
            java.lang.reflect.Method register = clientPlayNetworking.getMethod("register", ResourceLocation.class, serverPlayPacketConsumer);
            ...
            Object consumer = java.lang.reflect.Proxy.newProxyInstance(
                ...
                (proxy, method, args) -> {
                    ...
                    if (args != null && args.length > 1 && args[1] != null) {
                        try {
                            Object buf = args[1];
                            java.lang.reflect.Method readUtf = buf.getClass().getMethod("readUtf", int.class);
        ...
        try {
            ...
            java.lang.reflect.Method registerHud = eventObj.getClass().getMethod("register", hudCallbackClass);

            Object hudListener = java.lang.reflect.Proxy.newProxyInstance(
                PerformanceOverlayClient.class.getClassLoader(),
                ...
                (proxy, method, args) -> {
                    try {
                        ...
                        float partial = 0f;
                        if (args != null && args.length > 1 && args[1] instanceof Float) partial = (Float) args[1];
        ...
        try {
            // Try to access vanilla client packet listener registration: Minecraft.getInstance().getConnection().addListener
            // The exact API differs across mappings; attempt to find a registerReceiver method on net.minecraft.client.Minecraft
            ...
            if (conn != null) {
                // Try to find a method named 'addListener' or 'setListener' or 'register' that takes a ResourceLocation and a BiConsumer
                // This is fragile; if not available we will fall back to chat fallback and expose lines buffer.
            }
        } catch (Throwable t) {
            // ignore
        }

        // If we couldn't register a packet handler, we still accept performance lines via chat fallback.
    }
    ...
    public static void renderOverlay(net.minecraft.client.gui.GuiGraphics graphics, float partialTicks) {
            ...
            synchronized (lines) {
                ...
                for (String s : lines) {
                    ...
                    try {
                        ...
                        try {
                            java.lang.reflect.Method draw = font.getClass().getMethod("draw", net.minecraft.client.gui.GuiGraphics.class, String.class, int.class, int.class, int.class);
                            // If GuiGraphics is not available here, this will throw; we ignore
                            draw.invoke(font, null, s, x, yy, 0xFFFFFF);
                        } catch (NoSuchMethodException ns) {
                            try {
                                java.lang.reflect.Method draw2 = font.getClass().getMethod("draw", String.class, float.class, float.class, int.class);
                                draw2.invoke(font, s, (float) x, (float) yy, 0xFFFFFF);
                            } catch (NoSuchMethodException ns2) {
                                // try older drawString
                                java.lang.reflect.Method draw3 = font.getClass().getMethod("drawString", String.class, int.class, int.class, int.class);
