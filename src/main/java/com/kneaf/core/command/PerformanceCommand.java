  ...
  private static int metrics(CommandContext<CommandSourceStack> context) {
    ...
    String msg =
        String.format(
            ...
            RustPerformance.getTotalEntitiesProcessed(),
            RustPerformance.getTotalMobsProcessed(),
            RustPerformance.getTotalBlocksProcessed(),
            RustPerformance.getTotalMerged(),
            RustPerformance.getTotalDespawned());
    source.sendSuccess(() -> Component.literal(msg), false);
    return 1;
  }
