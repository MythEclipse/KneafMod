...
public class ModCompatibility {
    ...
    private static final Map<String, String> COMPAT_DESCRIPTIONS = Map.of(
        "ferritecore", "FerriteCore provides memory/pooling optimizations and is compatible with KneafMod. When present, KneafMod will avoid duplicating pooling logic and prefers FerriteCore's implementations."
    );
