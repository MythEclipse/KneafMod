...
public class SwapConfiguration {
    ...
    private void validate() {
        ...
        if (criticalMemoryThreshold <= highMemoryThreshold) {
            throw new IllegalArgumentException("Critical memory threshold must be greater than high memory threshold");
        }
        if (highMemoryThreshold <= elevatedMemoryThreshold) {
            throw new IllegalArgumentException("High memory threshold must be greater than elevated memory threshold");
        }
    }
