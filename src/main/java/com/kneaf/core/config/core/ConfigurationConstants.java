...
public final class ConfigurationConstants {
    ...
    public static final int DEFAULT_MAX_THREAD_POOL_SIZE = Math.max(1, Runtime.getRuntime().availableProcessors() - 1);
    public static final int DEFAULT_NETWORK_EXECUTOR_POOL_SIZE = Math.max(1, Runtime.getRuntime().availableProcessors() / 2);
