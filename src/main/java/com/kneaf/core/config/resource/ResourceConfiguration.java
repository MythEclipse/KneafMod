...
public class ResourceConfiguration implements ConfigurationProvider {
    ...
    public void validate() {
        ConfigurationUtils.validatePositive(resourceCleanupIntervalSeconds, "Resource cleanup interval");
        ConfigurationUtils.validatePositive(resourceHealthCheckIntervalSeconds, "Resource health check interval");
        ...
        ConfigurationUtils.validateMinMax(resourcePoolInitialSize, resourcePoolMaxSize, "resourcePoolInitialSize", "resourcePoolMaxSize");
    }
    
    @Override
    public boolean isEnabled() { return true; } // Resource configuration is always enabled
    ...
    public static class Builder {
        private int resourceCleanupIntervalSeconds = ConfigurationConstants.DEFAULT_RESOURCE_CLEANUP_INTERVAL_SECONDS;
        private int resourceHealthCheckIntervalSeconds = ConfigurationConstants.DEFAULT_RESOURCE_HEALTH_CHECK_INTERVAL_SECONDS;
