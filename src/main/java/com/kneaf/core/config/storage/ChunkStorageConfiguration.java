...
public class ChunkStorageConfiguration implements ConfigurationProvider {
    ...
    public long getMaintenanceIntervalMinutes() { return maintenanceIntervalMinutes; }
    public boolean isEnableBackups() { return enableBackups; }
    public String getBackupPath() { return backupPath; }
    public boolean isEnableChecksums() { return enableChecksums; }
    public boolean isEnableCompression() { return enableCompression; }
    public int getMaxBackupFiles() { return maxBackupFiles; }
    public long getBackupRetentionDays() { return backupRetentionDays; }
    public String getDatabaseType() { return databaseType; }
    public boolean isUseRustDatabase() { return useRustDatabase; }
    
    @Override
    public String toString() {
        return String.format("ChunkStorageConfiguration{enabled=%s, cacheCapacity=%d, evictionPolicy='%s', " +
    ...
    public static ChunkStorageConfiguration createDefault() {
        return new Builder().enabled(ConfigurationConstants.DEFAULT_ENABLED)
    ...
    public static class Builder {
        ...
        public Builder cacheCapacity(int cacheCapacity) { this.cacheCapacity = cacheCapacity; return this; }
        public Builder evictionPolicy(String evictionPolicy) { this.evictionPolicy = evictionPolicy; return this; }
        public Builder asyncThreadPoolSize(int asyncThreadPoolSize) { this.asyncThreadPoolSize = asyncThreadPoolSize; return this; }
        public Builder enableAsyncOperations(boolean enableAsyncOperations) { this.enableAsyncOperations = enableAsyncOperations; return this; }
        public Builder maintenanceIntervalMinutes(long maintenanceIntervalMinutes) { this.maintenanceIntervalMinutes = maintenanceIntervalMinutes; return this; }
        public Builder enableBackups(boolean enableBackups) { this.enableBackups = enableBackups; return this; }
        public Builder backupPath(String backupPath) { this.backupPath = backupPath; return this; }
        public Builder enableChecksums(boolean enableChecksums) { this.enableChecksums = enableChecksums; return this; }
        public Builder enableCompression(boolean enableCompression) { this.enableCompression = enableCompression; return this; }
        public Builder maxBackupFiles(int maxBackupFiles) { this.maxBackupFiles = maxBackupFiles; return this; }
        public Builder backupRetentionDays(long backupRetentionDays) { this.backupRetentionDays = backupRetentionDays; return this; }
        public Builder databaseType(String databaseType) { this.databaseType = databaseType; return this; }
        public Builder useRustDatabase(boolean useRustDatabase) { this.useRustDatabase = useRustDatabase; return this; }
