...
public class SwapConfiguration implements ConfigurationProvider {
    ...
    public void validate() {
        ...
        ConfigurationUtils.validateMinMax(elevatedMemoryThreshold, highMemoryThreshold, "elevatedMemoryThreshold", "highMemoryThreshold");
        ConfigurationUtils.validateMinMax(highMemoryThreshold, criticalMemoryThreshold, "highMemoryThreshold", "criticalMemoryThreshold");
    }
    ...
    public String toString() {
        return String.format("SwapConfiguration{enabled=%s, memoryCheckIntervalMs=%d, maxConcurrentSwaps=%d, " +
                           ...
                           enabled, memoryCheckIntervalMs, maxConcurrentSwaps, swapBatchSize, swapTimeoutMs,
                           enableAutomaticSwapping, criticalMemoryThreshold, highMemoryThreshold,
                           elevatedMemoryThreshold, minSwapChunkAgeMs, enableSwapStatistics,
    ...
    public static class Builder {
        ...
        public Builder maxConcurrentSwaps(int maxConcurrentSwaps) { this.maxConcurrentSwaps = maxConcurrentSwaps; return this; }
        public Builder swapBatchSize(int swapBatchSize) { this.swapBatchSize = swapBatchSize; return this; }
        public Builder swapTimeoutMs(long swapTimeoutMs) { this.swapTimeoutMs = swapTimeoutMs; return this; }
        public Builder enableAutomaticSwapping(boolean enableAutomaticSwapping) { this.enableAutomaticSwapping = enableAutomaticSwapping; return this; }
        public Builder criticalMemoryThreshold(double criticalMemoryThreshold) { this.criticalMemoryThreshold = criticalMemoryThreshold; return this; }
        public Builder highMemoryThreshold(double highMemoryThreshold) { this.highMemoryThreshold = highMemoryThreshold; return this; }
        public Builder elevatedMemoryThreshold(double elevatedMemoryThreshold) { this.elevatedMemoryThreshold = elevatedMemoryThreshold; return this; }
        public Builder minSwapChunkAgeMs(int minSwapChunkAgeMs) { this.minSwapChunkAgeMs = minSwapChunkAgeMs; return this; }
        public Builder enableSwapStatistics(boolean enableSwapStatistics) { this.enableSwapStatistics = enableSwapStatistics; return this; }
        public Builder enablePerformanceMonitoring(boolean enablePerformanceMonitoring) { this.enablePerformanceMonitoring = enablePerformanceMonitoring; return this; }
