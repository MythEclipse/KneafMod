...
/**
 * Compatibility shim for legacy import path com.kneaf.core.data.VillagerData. Delegates to the real
 * implementation in com.kneaf.core.data.entity.VillagerData.
 */
