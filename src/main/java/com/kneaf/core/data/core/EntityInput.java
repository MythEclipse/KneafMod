...
public class EntityInput {
    ...
    public EntityInput(List<EntityData> entities, List<PlayerData> players, List<MobData> mobs,
                      List<VillagerData> villagers, List<ItemEntityData> items, List<BlockEntityData> blockEntities) {
    ...
    public int getTotalEntityCount() {
        return entities.size() + players.size() + mobs.size() + 
               villagers.size() + items.size() + blockEntities.size();
    }
    ...
    public boolean hasEntities() {
        return !entities.isEmpty() || !players.isEmpty() || !mobs.isEmpty() ||
               !villagers.isEmpty() || !items.isEmpty() || !blockEntities.isEmpty();
    }
}