...
/**
 * Legacy compatibility wrapper for KneafCoreException. Extends the new enhanced exception class to
...
public class KneafCoreException extends RuntimeException {
  ...
  public KneafCoreException(ErrorCategory category, String message) {
    super(message);
    this.delegate =
        com.kneaf.core.exceptions.core.KneafCoreException.builder()
  ...
  public KneafCoreException(
      ErrorCategory category, String operation, String message, Object context, Throwable cause) {
    super(formatMessage(category, operation, message), cause);
    this.delegate =
        com.kneaf.core.exceptions.core.KneafCoreException.builder()
            .category(convertCategory(category))
  ...
  private static com.kneaf.core.exceptions.core.KneafCoreException.ErrorCategory convertCategory(
  ...
  private static ErrorCategory convertCategoryBack(
      com.kneaf.core.exceptions.core.KneafCoreException.ErrorCategory category) {
    if (category == null) return null;
