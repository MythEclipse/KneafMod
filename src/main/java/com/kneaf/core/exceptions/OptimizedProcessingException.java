...
/**
 * Legacy compatibility wrapper for OptimizedProcessingException.
...
public class OptimizedProcessingException extends RuntimeException {
    ...
    public OptimizedProcessingException(ErrorType errorType, String operation, String message) {
        super(message);
        this.delegate = com.kneaf.core.exceptions.processing.OptimizedProcessingException.builder()
    ...
    private static com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType convertErrorType(ErrorType errorType) {
        if (errorType == null) return null;
        
        switch (errorType) {
            case BATCH_PROCESSING_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.BATCH_PROCESSING_ERROR;
            case MEMORY_ALLOCATION_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.MEMORY_ALLOCATION_ERROR;
            case NATIVE_LIBRARY_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.NATIVE_LIBRARY_ERROR;
            case PREDICTIVE_LOADING_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.PREDICTIVE_LOADING_ERROR;
            case BUFFER_POOL_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.BUFFER_POOL_ERROR;
            case WORKER_EXECUTION_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.WORKER_EXECUTION_ERROR;
            case TIMEOUT_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.TIMEOUT_ERROR;
            case RESOURCE_EXHAUSTION_ERROR:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.RESOURCE_EXHAUSTION_ERROR;
            default:
                return com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType.BATCH_PROCESSING_ERROR;
        }
    }
    
    private static ErrorType convertErrorTypeBack(com.kneaf.core.exceptions.processing.OptimizedProcessingException.ProcessingErrorType errorType) {
        if (errorType == null) return null;
