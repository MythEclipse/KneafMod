...
/**
 * Interface for handling exceptions in a standardized way. Implementations can provide different
 * handling strategies based on severity and context.
 */
public interface ExceptionHandler {
  ...
  void handleException(
      Throwable exception, ExceptionSeverity severity, String context, String operation);
