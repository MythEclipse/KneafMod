...
/**
 * Interface for logging exceptions with structured information.
...
public interface ExceptionLogger {
     ...
     */
    void logException(Throwable exception, ExceptionSeverity severity, String message, Object context);
    
    /**
     * Logs an exception with structured data
     */
    void logException(Throwable exception, ExceptionSeverity severity, String message, 
                     String operation, String component, Object context);
