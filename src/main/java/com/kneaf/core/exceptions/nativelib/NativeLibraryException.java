...
/**
 * Exception thrown for native library operation failures. Replaces RustPerformanceException and
 * handles native library specific errors.
 */
public class NativeLibraryException extends BaseKneafException {

  public enum NativeErrorType {
    LIBRARY_NOT_AVAILABLE(
        ExceptionConstants.CODE_NATIVE_LIBRARY_NOT_AVAILABLE, "Native library is not available"),
    LIBRARY_LOAD_FAILED(
        ExceptionConstants.CODE_NATIVE_LIBRARY_LOAD_FAILED, "Failed to load native library"),
  ...
  public static NativeLibraryException jniError(
      String libraryName, String method, String message, Throwable cause) {
    return builder()
  ...
  public static NativeLibraryException memoryAllocationFailed(
      String libraryName, String operation, String details) {
    return builder()
