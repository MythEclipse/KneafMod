...
/**
 * Exception thrown for async processing operation failures. Replaces
 * BatchRequestInterruptedException and handles async processing specific errors.
 */
public class AsyncProcessingException extends BaseKneafException {

  public enum AsyncErrorType {
    BATCH_REQUEST_INTERRUPTED(
        ExceptionConstants.CODE_ASYNC_INTERRUPTED, "Batch request interrupted"),
