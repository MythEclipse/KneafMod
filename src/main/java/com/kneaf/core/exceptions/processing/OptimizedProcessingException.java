...
/**
 * Exception for optimized processing operations. Consolidates various processing-related exceptions
 * into a unified exception hierarchy.
 */
public class OptimizedProcessingException extends BaseKneafException {

  public enum ProcessingErrorType {
    BATCH_PROCESSING_ERROR(
        ExceptionConstants.CODE_PROCESSING_BATCH_FAILED, "Batch processing failed"),
    MEMORY_ALLOCATION_ERROR(
        ExceptionConstants.CODE_PROCESSING_MEMORY_FAILED, "Memory allocation failed"),
    NATIVE_LIBRARY_ERROR(
        ExceptionConstants.CODE_PREFIX_NATIVE + "005", "Native library operation failed"),
    ...
    RESOURCE_EXHAUSTION_ERROR(
        ExceptionConstants.CODE_PROCESSING_RESOURCE_EXHAUSTION, "Resource exhaustion detected");
