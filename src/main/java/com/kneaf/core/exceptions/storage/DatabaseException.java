...
/**
 * Exception thrown for database operation failures. Replaces the duplicate
 * DatabaseOperationException and RustDatabaseException classes.
 */
public class DatabaseException extends BaseKneafException {
  ...
  public enum DatabaseErrorType {
    ...
    TRANSACTION_FAILED(
        ExceptionConstants.CODE_DB_TRANSACTION_FAILED, "Database transaction failed"),
    ...
    NATIVE_LIBRARY_ERROR(
        ExceptionConstants.CODE_PREFIX_NATIVE + "006", "Native database library error"),
  ...
  public static DatabaseException validationFailed(
      String databaseType, String key, String message) {
    return builder()
