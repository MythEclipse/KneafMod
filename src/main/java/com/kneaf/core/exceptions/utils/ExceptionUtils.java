...
public final class ExceptionUtils {
     ...
     */
    public static void logExceptionWithContext(Logger logger, ExceptionSeverity severity, 
                                             String message, Throwable throwable, ExceptionContext context) {
    ...
    public static void safeExecute(Runnable runnable, String operationName, ExceptionSeverity severity) {
        try {
            ...
            logException(LOGGER, severity, 
                        String.format("Safe execution failed for operation: %s", operationName), e);
        }
    }
