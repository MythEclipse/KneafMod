...
public class MobFlatBuffers {
    ...
    public static ByteBuffer serializeMobInput(long tickCount, java.util.List<com.kneaf.core.data.MobData> mobs) {
        ...
        for (int i = 0; i < mobs.size(); i++) {
            ...
            mobOffsets[i] = createMobData(builder, mob.id(), mob.distance(), mob.isPassive(), entityTypeOffset);
        }
    ...
    // MobData methods
    public static int createMobData(FlatBufferBuilder builder, long id, double distance, boolean isPassive, int entityType) {
