...
/**
 * Abstract base class for flatbuffer serializers.
 * Provides common functionality and buffer management for all serializers.
 */
public abstract class BaseFlatBufferSerializer<T, R> implements FlatBufferSerializer<T, R> {
     ...
     */
    protected BaseFlatBufferSerializer(String serializerType, String schemaVersion, BufferPool bufferPool) {
     ...
     */
    protected BaseFlatBufferSerializer(String serializerType, String schemaVersion, 
                                     BufferPool bufferPool, SchemaValidator<T> validator) {
    ...
    public byte[] serialize(T input) throws SerializationException {
        ...
        try {
            ...
            throw new SerializationException("Serialization failed", e, serializerType, "serialize", 
    ...
    public R deserialize(byte[] data) throws SerializationException {
        ...
        try {
            ...
            throw new SerializationException("Deserialization failed", e, serializerType, "deserialize", data);
        } finally {
    ...
    public ByteBuffer serializeToBuffer(T input) throws SerializationException {
        ...
        // Validate input if validator is available
        if (validator != null && !validator.validate(input).isValid()) {
            throw new SerializationException("Input validation failed", serializerType, "serializeToBuffer");
        }
        ...
        try {
            ...
            throw new SerializationException("Serialization to buffer failed", e, serializerType, "serializeToBuffer", 
                                           buffer != null ? buffer.array() : null);
        }
    }
    ...
    public R deserializeFromBuffer(ByteBuffer buffer) throws SerializationException {
        if (buffer == null) {
            throw new SerializationException("Buffer cannot be null", serializerType, "deserializeFromBuffer");
        }
        ...
        try {
            ...
            throw new SerializationException("Deserialization from buffer failed", e, serializerType, 
                                           "deserializeFromBuffer", null);
        }
    }
    ...
    /**
     * Internal method to serialize input to buffer.
     ...
     */
    protected abstract void serializeToBufferInternal(T input, ByteBuffer buffer) throws SerializationException;
    
    /**
     * Internal method to deserialize from buffer.
     * Subclasses must implement this method.
     * 
     ...
     */
    protected abstract R deserializeFromBufferInternal(ByteBuffer buffer) throws SerializationException;
    ...
    /**
     * Release resources used by this serializer.
     * This should be called when the serializer is no longer needed.
     */
