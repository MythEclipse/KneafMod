...
/**
 * Serializer for entity data using flatbuffer format.
 * Handles serialization and deserialization of entity lists with player context.
 */
public class EntitySerializer extends BaseFlatBufferSerializer<EntityInput, List<Long>> {
    ...
    protected void serializeToBufferInternal(EntityInput input, ByteBuffer buffer) throws SerializationException {
        if (input == null) {
            throw new SerializationException("Entity input cannot be null", getSerializerType(), "serializeToBufferInternal");
        }
        ...
        try {
            ...
            throw new SerializationException("Failed to serialize entity input", e, getSerializerType(), 
    ...
    protected List<Long> deserializeFromBufferInternal(ByteBuffer buffer) throws SerializationException {
        try {
            ...
            if (entityCount < 0 || entityCount > SerializationConstants.MAX_ENTITY_COUNT) {
                throw new SerializationException("Invalid entity count: " + entityCount, getSerializerType(), 
            ...
            if (playerCount < 0 || playerCount > SerializationConstants.MAX_ENTITY_COUNT) {
                throw new SerializationException("Invalid player count: " + playerCount, getSerializerType(), 
                                               "deserializeFromBufferInternal");
            }
            ...
            throw new SerializationException("Failed to deserialize entity result", e, getSerializerType(), 
