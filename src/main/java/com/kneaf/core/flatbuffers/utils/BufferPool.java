...
/**
 * Thread-safe buffer pool for reusable ByteBuffer instances.
 * Provides efficient buffer management to reduce garbage collection pressure.
 */
public class BufferPool {
    ...
    public static class BufferPoolStatistics {
        ...
        public BufferPoolStatistics(int availableCount, int activeCount, int totalCreated, 
                                  int maxPoolSize, int bufferSize) {
        ...
        public String toString() {
            return String.format("BufferPoolStatistics{available=%d, active=%d, totalCreated=%d, maxSize=%d, bufferSize=%d, utilization=%d%%}",
                availableCount, activeCount, totalCreated, maxPoolSize, bufferSize, getUtilizationPercent());
        }
    }
}