...
/**
 * Interface for validating flatbuffer schemas and data.
 * Implementations should provide schema-specific validation logic.
 */
public interface SchemaValidator<T> {
    ...
    class DetailedValidationResult {
        ...
        public DetailedValidationResult(boolean valid, java.util.List<String> errors, java.util.List<String> warnings) {
            this.valid = valid;
        ...
        public static DetailedValidationResult valid() {
            return new DetailedValidationResult(true, java.util.Collections.emptyList(), java.util.Collections.emptyList());
        }
        ...
        public static DetailedValidationResult invalidWithWarnings(java.util.List<String> errors, java.util.List<String> warnings) {
