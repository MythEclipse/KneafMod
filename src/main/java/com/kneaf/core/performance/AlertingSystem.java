...
public final class AlertingSystem {
    ...
    private void initializeDefaultRules() {
        ...
        addAlertRule("HIGH_RESOURCE_UTILIZATION", "Resource utilization exceeds threshold",
            metrics -> metrics.getOrDefault("system.resource_utilization", 0.0) > DEFAULT_RESOURCE_UTILIZATION_THRESHOLD,
    ...
    public static class AlertRule {
        ...
        public long getEscalationSeconds() { return escalationSeconds; }
    }
    ...
    public static class Alert {
        ...
        public boolean isResolved() { return !active; }
        ...
        public int getEscalationLevel() { return escalationLevel.get(); }
        public long getAgeSeconds() { return java.time.Duration.between(createdAt, Instant.now()).getSeconds(); }
    ...
    public static class AlertStatistics {
        ...
        public long getAlertsResolved() { return alertsResolved; }
        public int getActiveAlerts() { return activeAlerts; }
        public int getAlertHistory() { return alertHistory; }
        public long getNotificationsSent() { return notificationsSent; }
        public long getNotificationFailures() { return notificationFailures; }
