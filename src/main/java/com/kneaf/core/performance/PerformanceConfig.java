...
public final class PerformanceConfig {
  ...
  public int getNetworkExecutorpoolSize() {
    return delegate.getNetworkExecutorpoolSize();
  }

  public boolean isDynamicThreadScaling() {
    return delegate.isDynamicThreadScaling();
  }

  public boolean isWorkStealingEnabled() {
    return delegate.isWorkStealingEnabled();
  }

  public boolean isCpuAwareThreadSizing() {
    return delegate.isCpuAwareThreadSizing();
  }

  public int getMinThreadpoolSize() {
    return delegate.getMinThreadpoolSize();
  }

  public int getMaxThreadpoolSize() {
    return delegate.getMaxThreadpoolSize();
  }

  public double getThreadScaleUpThreshold() {
    return delegate.getThreadScaleUpThreshold();
  }

  public double getThreadScaleDownThreshold() {
    return delegate.getThreadScaleDownThreshold();
  }

  public int getThreadScaleUpDelayTicks() {
    return delegate.getThreadScaleUpDelayTicks();
  }

  public int getThreadScaleDownDelayTicks() {
    return delegate.getThreadScaleDownDelayTicks();
  }

  public int getThreadPoolKeepAliveSeconds() {
    return delegate.getThreadPoolKeepAliveSeconds();
  }
}
