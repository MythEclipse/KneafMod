...
/**
 * Lightweight compatibility shim exposing ExecutorMetrics used by tests.
 * The real implementation lives in com.kneaf.core.performance.monitoring.PerformanceManager.
 */
    ...
    public static final class ExecutorMetrics {
        ...
        public String toJson() {
            return String.format(
                ...
                totalTasksSubmitted, totalTasksCompleted, totalTasksRejected, currentQueueSize, currentUtilization, currentThreadCount, peakThreadCount, scaleUpCount, scaleDownCount
            );
        }
    }
}
