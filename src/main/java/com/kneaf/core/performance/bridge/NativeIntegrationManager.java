...
// import com.kneaf.core.performance.NativeBridge; // NativeBridge not available in current structure
...
public class NativeIntegrationManager implements NativeBridgeProvider {
    ...
    public boolean initialize() {
        if (initialized.compareAndSet(false, true)) {
            try {
                ...
                KneafCore.LOGGER.warn("Native allocator init failed; native integration unavailable, using Java fallback: {}", t.getMessage());
                return false;
            }
        }
    ...
    public long createWorker(int concurrency) throws RuntimeException {
        ...
        if (activeWorkers.size() >= maxWorkers) {
            throw new RuntimeException(
                "Maximum worker limit reached: " + maxWorkers);
        }
        ...
        try {
            ...
            if (workerHandle == 0) {
                throw new RuntimeException(
                    "Failed to create native worker");
            }
            ...
            KneafCore.LOGGER.debug("Created native worker {} with handle {} and concurrency {}", 
                                 workerId, workerHandle, concurrency);
            
            return workerId;
        } catch (Exception e) {
            throw new RuntimeException(
                "Failed to create native worker", e);
        }
    }
    ...
    public void destroyWorker(long workerId) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException(
                "Failed to destroy native worker " + workerId, e);
        }
    }
    ...
    public void pushTask(long workerId, byte[] payload) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException(
                "Failed to push task to worker " + workerId, e);
        }
    }
    ...
    public void pushBatch(long workerId, byte[][] payloads) throws RuntimeException {
        ...
        try {
            com.kneaf.core.performance.NativeBridge.nativePushBatch(workerInfo.handle, payloads, payloads.length);
            workerInfo.incrementTaskCount(payloads.length);
        } catch (Exception e) {
            throw new RuntimeException(
                "Failed to push batch to worker " + workerId, e);
        }
    }
    ...
    public byte[] pollResult(long workerId) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException(
                "Failed to poll result from worker " + workerId, e);
        }
    }
    ...
    public WorkerStatistics getWorkerStatistics(long workerId) throws RuntimeException {
        ...
        try {
            long queueDepth = com.kneaf.core.performance.NativeBridge.nativeGetWorkerQueueDepth(workerInfo.handle);
            double avgProcessingMs = com.kneaf.core.performance.NativeBridge.nativeGetWorkerAvgProcessingMs(workerInfo.handle);
            long memoryUsage = com.kneaf.core.performance.NativeBridge.nativeGetWorkerMemoryUsage(workerInfo.handle);
            ...
            throw new RuntimeException(
                "Failed to get statistics for worker " + workerId, e);
        }
    }
    ...
    public Map<Long, WorkerStatistics> getAllWorkerStatistics() {
        ...
        for (Long workerId : activeWorkers.keySet()) {
            try {
                ...
                KneafCore.LOGGER.warn("Failed to get statistics for worker {}: {}", workerId, e.getMessage());
            }
        }
        return stats;
    }
    ...
    @Override
    public java.util.concurrent.CompletableFuture<Integer> preGenerateNearbyChunksAsync(int centerX, int centerZ, int radius) {
    ...
    public NativeFloatBufferAllocation generateFloatBufferWithShape(long rows, long cols) {
        ...
        ByteBuffer buffer = ByteBuffer.allocateDirect(count * 4).order(java.nio.ByteOrder.LITTLE_ENDIAN);
    ...
    public static class WorkerStatistics {
        ...
        public WorkerStatistics(long workerId, long queueDepth, double avgProcessingMs, 
                              long memoryUsage, long taskCount, long resultCount) {
        ...
        public String toString() {
            return String.format("WorkerStatistics{id=%d, queueDepth=%d, avgProcessingMs=%.2f, memoryUsage=%d, taskCount=%d, resultCount=%d}",
