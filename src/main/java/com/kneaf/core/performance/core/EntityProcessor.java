...
public class EntityProcessor {
    ...
    public List<Long> processEntities(List<EntityData> entities, List<PlayerData> players) {
        ...
        try {
            ...
            ProtocolProcessor.ProtocolResult<List<Long>> result = protocolProcessor.processWithFallback(
                ...
                new ProtocolProcessor.BinarySerializer<EntityInput>() {
                    ...
                    public ByteBuffer serialize(EntityInput input) throws Exception {
                        return ManualSerializers.serializeEntityInput(tickCount++, input.entities, input.players);
                    }
                },
            ...
            monitor.recordEntityProcessing(processedEntities.size(), System.currentTimeMillis() - startTime);
    ...
    public static class BatchRequest {
        ...
        public BatchRequest(String type, Object data, java.util.concurrent.CompletableFuture<Object> future) {
            this.type = type;
            this.data = data;
            this.future = future;
        }
     ...
     */
    public ItemProcessResult processItemEntities(List<com.kneaf.core.data.item.ItemEntityData> items) {
        long startTime = System.currentTimeMillis();
        
        try {
            // Use protocol processor for unified binary/JSON processing
            ProtocolProcessor.ProtocolResult<ItemProcessResult> result = protocolProcessor.processWithFallback(
                items,
                "Item processing",
                new ProtocolProcessor.BinarySerializer<List<com.kneaf.core.data.item.ItemEntityData>>() {
                    @Override
                    public ByteBuffer serialize(List<com.kneaf.core.data.item.ItemEntityData> input) throws Exception {
                ...
                new ProtocolProcessor.JsonInputPreparer<List<com.kneaf.core.data.item.ItemEntityData>>() {
                    @Override
                    public Map<String, Object> prepareInput(List<com.kneaf.core.data.item.ItemEntityData> jsonInput) {
            ...
            monitor.recordItemProcessing(items.size(), processedItems.getMergedCount(), processedItems.getDespawnedCount(),
    ...
    public MobProcessResult processMobAI(List<com.kneaf.core.data.entity.MobData> mobs) {
        ...
        try {
            // Use protocol processor for unified binary/JSON processing
            ProtocolProcessor.ProtocolResult<MobProcessResult> result = protocolProcessor.processWithFallback(
                mobs,
                "Mob processing",
                new ProtocolProcessor.BinarySerializer<List<com.kneaf.core.data.entity.MobData>>() {
                    @Override
                    public ByteBuffer serialize(List<com.kneaf.core.data.entity.MobData> input) throws Exception {
                ...
                new ProtocolProcessor.JsonInputPreparer<List<com.kneaf.core.data.entity.MobData>>() {
                    @Override
                    public Map<String, Object> prepareInput(List<com.kneaf.core.data.entity.MobData> jsonInput) {
                        Map<String, Object> input = new HashMap<>();
            ...
            monitor.recordMobProcessing(mobs.size(), processedMobs.getDisableList().size(), processedMobs.getSimplifyList().size(),
                                      System.currentTimeMillis() - startTime);
    ...
    public List<Long> processVillagerAI(List<VillagerData> villagers) {
        ...
        try {
            ...
            monitor.recordVillagerProcessing(villagers.size(), 0, processedVillagers.size(), 0,
                                           System.currentTimeMillis() - startTime);
            ...
            monitor.recordVillagerProcessing(villagers.size(), 0, fallback.size(), 0, System.currentTimeMillis() - startTime);
            return fallback;
        }
    }
     ...
     */
    public List<Long> getBlockEntitiesToTick(List<com.kneaf.core.data.block.BlockEntityData> blockEntities) {
        long startTime = System.currentTimeMillis();
        ...
        try {
            ...
            ProtocolProcessor.ProtocolResult<List<Long>> result = protocolProcessor.processWithFallback(
                blockEntities,
                "Block processing",
                new ProtocolProcessor.BinarySerializer<List<com.kneaf.core.data.block.BlockEntityData>>() {
                    @Override
                    public ByteBuffer serialize(List<com.kneaf.core.data.block.BlockEntityData> input) throws Exception {
                ...
                new ProtocolProcessor.JsonInputPreparer<List<com.kneaf.core.data.block.BlockEntityData>>() {
                    @Override
                    public Map<String, Object> prepareInput(List<com.kneaf.core.data.block.BlockEntityData> jsonInput) {
                        Map<String, Object> input = new HashMap<>();
                        input.put(PerformanceConstants.TICK_COUNT_KEY, tickCount++);
