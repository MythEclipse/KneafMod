...
public final class PerformanceConstants {
   ...
   */
  @Deprecated public static final int DEFAULT_BATCH_SIZE = 100;

  /**
   * @deprecated Use {@link #getAdaptiveBatchTimeoutMs(double,double)} instead. Value in ms.
   */
  @Deprecated public static final long DEFAULT_BATCH_TIMEOUT_MS = 50;

  /**
   * @deprecated Use {@link #getAdaptiveBatchProcessorSleepMs(double)} instead.
   */
  @Deprecated public static final int BATCH_PROCESSOR_SLEEP_MS = 5;
   ...
   */
  @Deprecated public static final int MAX_CONNECTIONS = 10;

  /**
   * @deprecated Use {@link #getAdaptiveInitialConnections(double)} instead.
   */
  @Deprecated public static final int INITIAL_CONNECTIONS = 5;
   ...
   */
  @Deprecated public static final double DEFAULT_TPS_THRESHOLD = 19.0;

  /**
   * @deprecated Use live values from PerformanceManager and adaptive getters.
   */
  @Deprecated public static final double MIN_TPS_THRESHOLD = 10.0;

  /**
   * @deprecated Use live values from PerformanceManager and adaptive getters.
   */
  @Deprecated public static final double MAX_TPS_THRESHOLD = 20.0;
   ...
   */
  @Deprecated public static final double DEFAULT_DISTANCE_CUTOFF = 256.0;

  /**
   * @deprecated Use {@link #getAdaptiveDistanceCalculationInterval(double)} instead.
   */
  @Deprecated public static final int DISTANCE_CALCULATION_INTERVAL = 10;

  // Spatial grid constants (fallbacks)
  /**
   * @deprecated Use {@link #getAdaptiveCellSize(double)} instead.
   */
  @Deprecated public static final double DEFAULT_CELL_SIZE = 32.0;

  /**
   * @deprecated Use adaptive spatial grid update thresholds if needed.
   */
  @Deprecated public static final double SPATIAL_GRID_UPDATE_THRESHOLD = 1.0;

  // Buffer pooling constants (fallbacks)
  /**
   * @deprecated Use {@link #getAdaptiveBUFFER_poolSize(double)} instead.
   */
  @Deprecated public static final int BUFFER_POOL_SIZE = 50;

  /**
   * @deprecated Use {@link #getAdaptiveMaxBufferSize(double)} instead. Value in bytes.
   */
  @Deprecated public static final int MAX_BUFFER_SIZE = 1024 * 1024; // 1MB

  /**
   * @deprecated Use {@link #getAdaptiveBufferUseThreshold(double)} instead. Value in bytes.
   */
  @Deprecated public static final int BUFFER_USE_THRESHOLD = 8192; // 8KB
  ...
  /**
   * @deprecated Use {@link #getAdaptiveCoreThreads(double)} and {@link
   *     #getAdaptiveMaxThreads(double)} instead.
   */
  @Deprecated
   ...
   */
  @Deprecated public static final int MAX_THREADS = Math.max(8, CORE_THREADS * 2);

  /**
   * @deprecated Use {@link #getAdaptiveThreadKeepAliveSeconds(double)} instead. Value in seconds.
   */
  @Deprecated public static final long THREAD_KEEP_ALIVE_TIME = 60L;

  /**
   * @deprecated Use {@link #getAdaptiveQueueCapacity(double)} instead.
   */
  @Deprecated public static final int QUEUE_CAPACITY = 1000;
   ...
   */
  @Deprecated public static final int DEFAULT_LOG_INTERVAL_TICKS = 100;

  /**
   * @deprecated Use {@link #getAdaptiveMaxLogBytes(double)} instead.
   */
  @Deprecated public static final long DEFAULT_MAX_LOG_BYTES = 10L * 1024 * 1024; // 10MB
   ...
   */
  @Deprecated public static final long DEFAULT_SLOW_TICK_THRESHOLD_MS = 50L;

  /**
   * @deprecated Use {@link #getAdaptiveProfilingSampleRate(double)} instead.
   */
  @Deprecated public static final int DEFAULT_PROFILING_SAMPLE_RATE = 100;
   ...
   */
  @Deprecated public static final int CHUNK_GENERATION_TIMEOUT_MS = 30000;
  ...
  /**
   * Maximum buffer size we attempt to pool/allow for direct buffers. When server is under heavy
   * load (low TPS) reduce the maximum to avoid large pooled allocations.
   */
