...
public interface PerformanceMonitor {
     ...
     */
    void recordItemProcessing(int itemsProcessed, long itemsMerged, long itemsDespawned, long processingTime);
    
    /**
     * Record mob processing metrics.
     */
    void recordMobProcessing(int mobsProcessed, int mobsDisabledAI, int mobsSimplifiedAI, long processingTime);
    
    /**
     * Record villager processing metrics.
     */
    void recordVillagerProcessing(int villagersProcessed, int villagersDisabledAI, int villagersSimplifiedAI, int villagersReducedPathfinding, long processingTime);
