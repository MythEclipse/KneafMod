...
public interface PerformanceProcessor {
  ...
  class VillagerProcessResult {
    ...
    public VillagerProcessResult(
        List<Long> disableList, List<Long> simplifyList, List<Long> reducePathfindList) {
    ...
    public List<Long> getReducePathfindList() {
      return reducePathfindList;
    }
  }
}
