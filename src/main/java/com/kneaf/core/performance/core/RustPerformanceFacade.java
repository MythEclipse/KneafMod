...
/**
 * Facade class that provides a unified interface to the performance optimization system.
 * This class delegates to the underlying components: EntityProcessor, BatchProcessor, 
...
public class RustPerformanceFacade {
    ...
    private RustPerformanceFacade() {
        ...
        this.monitor = new PerformanceMonitor() {
            ...
            @Override
            public long getTotalEntitiesProcessed() { return totalEntities.get(); }
            
            @Override
            public long getTotalItemsProcessed() { return totalItems.get(); }
            
            @Override
            public long getTotalMobsProcessed() { return totalMobs.get(); }
            
            @Override
            public long getTotalBlocksProcessed() { return totalBlocks.get(); }
            
            @Override
            public long getTotalItemsMerged() { return totalItemsMerged.get(); }
            
            @Override
            public long getTotalItemsDespawned() { return totalItemsDespawned.get(); }
            ...
            public void logPerformanceSummary() {
                KneafCore.LOGGER.info("Performance Summary - Entities: {}, Items: {}, Mobs: {}, Blocks: {}, TPS: {}",
                    totalEntities.get(), totalItems.get(), totalMobs.get(), totalBlocks.get(), currentTPS);
            }
        ...
        this.nativeManager = new NativeIntegrationManager(monitor);
        this.entityProcessor = new EntityProcessor(nativeManager, monitor);
        this.batchProcessor = new BatchProcessor(entityProcessor, monitor, nativeManager);
        this.optimizer = new PerformanceOptimizer(monitor, nativeManager, entityProcessor, batchProcessor);
    }
    ...
    public synchronized void initialize() {
        ...
        try {
            ...
            boolean nativeAvailable = nativeManager.initialize();
    ...
    public ItemProcessResult processItemEntities(List<ItemEntityData> items) {
        ...
        try {
            ...
            if (items.size() >= 25 && nativeManager.isNativeAvailable()) {
    ...
    public MobProcessResult processMobAI(List<MobData> mobs) {
        ...
        try {
            ...
            if (mobs.size() >= 25 && nativeManager.isNativeAvailable()) {
    ...
    public List<Long> processVillagerAI(List<VillagerData> villagers) {
        ...
        try {
            ...
            if (villagers.size() >= 25 && nativeManager.isNativeAvailable()) {
    ...
    public List<Long> getBlockEntitiesToTick(List<BlockEntityData> blockEntities) {
        ...
        try {
            ...
            if (blockEntities.size() >= 25 && nativeManager.isNativeAvailable()) {
    ...
    public PerformanceStatistics getPerformanceStatistics() {
        ...
        return new PerformanceStatistics(
            ...
            nativeManager.isNativeAvailable(),
    ...
    public String getMemoryStats() {
        ...
        try {
            return nativeManager.getMemoryStats();
        } catch (Exception e) {
    ...
    public String getCpuStats() {
        ...
        try {
            return nativeManager.getCpuStats();
        } catch (Exception e) {
    ...
    public CompletableFuture<Integer> preGenerateNearbyChunksAsync(int centerX, int centerZ, int radius) {
        ...
        return nativeManager.preGenerateNearbyChunksAsync(centerX, centerZ, radius);
    }
    ...
    public boolean isChunkGenerated(int x, int z) {
        ...
        return nativeManager.isChunkGenerated(x, z);
    }
    ...
    public long getGeneratedChunkCount() {
        ...
        return nativeManager.getGeneratedChunkCount();
    }
    ...
    public int getNativeWorkerQueueDepth() {
        ...
        return nativeManager.getNativeWorkerQueueDepth();
    }
    ...
    public double getNativeWorkerAvgProcessingMs() {
        ...
        return nativeManager.getNativeWorkerAvgProcessingMs();
    }
    ...
    public boolean isNativeAvailable() {
        return nativeManager.isNativeAvailable();
    }
    ...
    public static class PerformanceStatistics {
        ...
        public PerformanceStatistics(long totalEntitiesProcessed,
        ...
        public PerformanceOptimizer.OptimizationStatistics getOptimizationStats() { return optimizationStats; }
        
        @Override
        public String toString() {
            return String.format("PerformanceStatistics{entities=%d, items=%d, mobs=%d, blocks=%d, avgTickTime=%.2fms, native=%s}",
                totalEntitiesProcessed, totalItemsProcessed, totalMobsProcessed, totalBlocksProcessed,
                averageTickTime, nativeAvailable);
        }
    }
}