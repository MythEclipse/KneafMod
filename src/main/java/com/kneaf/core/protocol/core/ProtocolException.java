...
public class ProtocolException extends Exception {
  ...
  public ProtocolException(
      String message, Throwable cause, int errorCode, String protocolFormat, String traceId) {
    super(message, cause);
    this.errorCode = errorCode;
    this.protocolFormat = protocolFormat;
    this.traceId = traceId;
   ...
   */
  public static ProtocolException validationFailed(
      String message, String protocolFormat, String traceId) {
    return new ProtocolException(
        message, ProtocolConstants.ERROR_CODE_VALIDATION_FAILED, protocolFormat, traceId);
  }
   ...
   */
  public static ProtocolException versionMismatch(
      String expectedVersion, String actualVersion, String traceId) {
    return new ProtocolException(
        String.format(
            "Protocol version mismatch. Expected: %s, Actual: %s", expectedVersion, actualVersion),
  ...
  public static ProtocolException integrityFailed(String message, String traceId) {
    return new ProtocolException(
        message, ProtocolConstants.ERROR_CODE_INTEGRITY_FAILED, null, traceId);
  }
  ...
  public static ProtocolException nativeFailed(String message, Throwable cause, String traceId) {
    return new ProtocolException(
        message, cause, ProtocolConstants.ERROR_CODE_NATIVE_FAILED, null, traceId);
  }
   ...
   */
  public static ProtocolException serializationFailed(
      String message, Throwable cause, String protocolFormat, String traceId) {
    return new ProtocolException(
        message, cause, ProtocolConstants.ERROR_CODE_SERIALIZATION_FAILED, protocolFormat, traceId);
  }
}
