...
public interface ProtocolLogger {
     ...
     */
    void logOperationStart(String operation, String protocolFormat, String traceId, Map<String, Object> metadata);
     ...
     * @param metadata additional metadata
     */
    void logOperationComplete(String operation, String protocolFormat, String traceId, long durationMs, boolean success, Map<String, Object> metadata);
     ...
     * @param metadata additional metadata
     */
    void logValidation(String validationType, ProtocolValidator.ValidationResult result, String traceId, Map<String, Object> metadata);
    ...
    class ProtocolLogEntry {
        ...
        public ProtocolLogEntry(String traceId, Instant timestamp, String operation, String protocolFormat, 
                              String level, String message, Map<String, Object> metadata) {
        ...
        public String getProtocolFormat() { return protocolFormat; }
