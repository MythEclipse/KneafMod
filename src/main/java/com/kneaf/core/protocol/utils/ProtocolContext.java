...
public class ProtocolContext {
  ...
  public static class Builder {
    ...
    public ProtocolContext build() {
      ...
      if (validator == null) {
        validator =
            new ProtocolValidatorImpl<>(
                Object.class, ProtocolConstants.MAX_JSON_SIZE, protocolVersion);
      }
  ...
  public static ProtocolContext forJson(String operation) {
    return builder().operation(operation).protocolFormat(ProtocolConstants.FORMAT_JSON).build();
  }
  ...
  public static ProtocolContext forBinary(String operation) {
    return builder().operation(operation).protocolFormat(ProtocolConstants.FORMAT_BINARY).build();
  }
}
