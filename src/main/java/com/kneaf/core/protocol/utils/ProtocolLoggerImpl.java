...
public class ProtocolLoggerImpl implements ProtocolLogger {
    ...
    public void logOperationStart(String operation, String protocolFormat, String traceId, Map<String, Object> metadata) {
        ProtocolLogEntry entry = new ProtocolLogEntry(
            traceId, Instant.now(), operation, protocolFormat, 
            ProtocolConstants.LOG_LEVEL_INFO, "Operation started", metadata
        );
    ...
    @Override
    public void logOperationComplete(String operation, String protocolFormat, String traceId, 
    ...
    @Override
    public void logValidation(String validationType, ProtocolValidator.ValidationResult result, 
                            String traceId, Map<String, Object> metadata) {
        String level = result.isValid() ? ProtocolConstants.LOG_LEVEL_INFO : ProtocolConstants.LOG_LEVEL_ERROR;
    ...
    public void logError(String operation, Exception error, String traceId, Map<String, Object> context) {
        ...
        ProtocolLogEntry entry = new ProtocolLogEntry(
            traceId, Instant.now(), operation, null, 
            ProtocolConstants.LOG_LEVEL_ERROR, "Operation failed with error", errorMetadata
        );
    ...
    public void logWarning(String operation, String warning, String traceId, Map<String, Object> context) {
        ...
        ProtocolLogEntry entry = new ProtocolLogEntry(
            traceId, Instant.now(), operation, null, 
            ProtocolConstants.LOG_LEVEL_WARN, warning, warningMetadata
        );
    ...
    public void logMetrics(String operation, Map<String, Number> metrics, String traceId) {
        ...
        ProtocolLogEntry entry = new ProtocolLogEntry(
            traceId, Instant.now(), operation, null,
            ProtocolConstants.LOG_LEVEL_INFO, "Performance metrics", metricsMetadata
        );
    ...
    private void logEntry(ProtocolLogEntry entry) {
        String jsonLog = GSON.toJson(Map.of(
            "logger", loggerName,
    ...
    public Map<String, Object> getStatistics() {
        ...
        // Count log levels
        Map<String, Long> levelCounts = recentLogs.values().stream()
            .collect(java.util.stream.Collectors.groupingBy(
                ProtocolLogEntry::getLevel,
